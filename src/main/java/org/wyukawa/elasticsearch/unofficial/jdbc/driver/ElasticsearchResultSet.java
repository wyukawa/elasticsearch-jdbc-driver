...
public class ElasticsearchResultSet implements ResultSet {
    ...
    public ElasticsearchResultSet(String sql, ElasticsearchResponse elasticsearchResponse) {
        this.sql = sql;
            ...
            throws SQLException
    {
        ...
        String type = elasticsearchColumn.getType();
        if(type.equals("text") || type.equals("keyword")) {
            return stringValue;
        } else if(type.equals("date")) {
            ZonedDateTime zdt = ZonedDateTime.parse(stringValue, DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ss.SSSX"));
            ...
            throw new IllegalArgumentException(String.format("%s is illegal", type));
        }
    }

    @Override
    public boolean next() throws SQLException {
        return elasticsearchResponse.getRows().size() > ++this.index;
    }
    ...
    public boolean getBoolean(int columnIndex) throws SQLException {
        return (Boolean)column(columnIndex - 1);
    }

    @Override
    public byte getByte(int columnIndex) throws SQLException {
        return (Byte)column(columnIndex - 1);
    }

    @Override
    public short getShort(int columnIndex) throws SQLException {
        return (Short)column(columnIndex - 1);
    }

    @Override
    public int getInt(int columnIndex) throws SQLException {
        return (Integer)column(columnIndex - 1);
    }

    @Override
    public long getLong(int columnIndex) throws SQLException {
        return (Long)column(columnIndex - 1);
    }

    @Override
    public float getFloat(int columnIndex) throws SQLException {
        return (Float)column(columnIndex - 1);
    }

    @Override
    public double getDouble(int columnIndex) throws SQLException {
        return (Double)column(columnIndex - 1);
    }
